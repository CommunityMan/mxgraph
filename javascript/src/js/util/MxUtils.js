...
export class MxUtils {
     ...
     * @returns {null|CSSStyleDeclaration|*} style of the specified element.
     */
     ...
     * these expressions.
     * @param expr A string that represents a JavaScript expression.
     * @returns {null}
     */
    static eval(expr) {
        let result = null;
        ...
        if (expr.indexOf('function') >= 0) {
            try {
                eval('let _mxJavaScriptExpression=' + expr);
    ...
    //TODO Check if it is still useful at the end of the conversion.
    /**
    ...
    /**
     *
     * @param array Array that contains the elements.
     * @param fn Function to be called for each object.
     * @returns {*}
     */
     ...
     * @param node Node to be imported.
     * @param allChildren If all children should be imported.
     * @returns {ActiveX.IXMLDOMText|Text|*}
     */
    ...
    static parseXml(xml) {
        if (window.DOMParser) {
            ...
            const doc = MxUtils.createMsXmlDocument();
            doc.loadXML(xml);
            return doc;
    ...
    //TODO complete doc from old code
    /**
     *
     * @param node
     * @param tab
    ...
    static replaceTrailingNewlines(str, pattern) {
        //TODO LATER: Check is this can be done with a regular expression
        let postfix = '';
    ...
    /**
     * Returns the text content of the specified node.
     * @param node DOM node to return the text content fo
     * @returns {*|string}
     */
     ...
     * @param parent DOM node to append the text node to.
     * @param String representing the text to be added.
     */
